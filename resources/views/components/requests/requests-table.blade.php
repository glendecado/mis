...
<div class="w-full" x-data="{ statusDropdownOpen: false }">
    ...
    @php
        $requests = $this->status == 'resolved' ? $this->viewRequest()->where('status', 'resolved') : $this->viewRequest()->where('status', '!=', 'resolved');
    @endphp
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                <div class="text-sm font-medium text-gray-900">
                                                    {{ $request->faculty->user->name ?? '' }}</div>
                                                <div class="text-sm text-gray-500">
                                                    {{ $request->faculty->department ?? '' }}</div>
                                            </div>
                                        </div>
                                    </td>
                                @endif
