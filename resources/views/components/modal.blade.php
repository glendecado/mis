...
<div x-cloak x-data="{
    ...
    x-on:close.stop="show = false; $dispatch('resetErrors')" 
    x-on:keydown.escape.window="show = false; $dispatch('resetErrors')" 
    x-on:keydown.tab.prevent="$event.shiftKey || nextFocusable().focus()" 
    x-on:keydown.shift.tab.prevent="prevFocusable().focus()" 
    x-show="show ?? ''" 

    class="fixed inset-0 overflow-y-auto px-4 sm:px-0 z-40 w-full h-dvh">
