<x-modal name="add-user-modal">
    <div class="p-2"> <!-- Added padding here -->
        <h1 class="text-3xl text-blue font-bold ml-2">Create New User Account</h1>
        <form wire:submit.prevent="addUser">
            <div class='y gap-2 p-2' x-data="{ <!-- Added padding here -->
                ...
                <div class='md:x y gap-2 mt-2' x-show="role == 'Faculty'"> <!-- Added padding here -->
                    <div class='y'>
                ...
                {{-- Email --}}
                <div class="y gap-2 mt-2"> <!-- Added padding here -->
                ...
                <button type="submit" class="button mt-2">Add User</button> <!-- Added padding here -->
            </div>
        </form>
    </div>
</x-modal>
