<div x-data="{ selectedCategoryId: null }" class="m-5 h-full p-4 table-container rounded-md"> <!-- Removed overflow-auto -->

<div> <!-- Added padding on both sides -->
    <h1 class="text-3xl font-bold mt-4" style="color: #2e5e91;">Category</h1>
</div>

    <div class="p-4 transition-all space-y-3"> <!-- Improved spacing between categories -->
        ...
        <div
    class="p-4 text-white cursor-pointer select-none flex justify-between items-center"
    ...
    <!-- Category Name -->
    <span class="flex-grow text-center text-lg">{{$category->name}}</span>
