<header class=" bg-blue-500">
    {{-- top --}}
    <div class="p-5 flex  justify-between md:flex-row flex-col md:gap-0 gap-2">
        <h1 class="text-blue-50 text-lg">MIS SERVICE REQUEST PORTAL</h1>
        <input type="text" class="rounded-full w-[250px] px-2 outline-none">
    </div>
...
{{-- navbar --}}
<nav class="bg-yellow basis-full">
    <div class=" h-12 justify-between flex">
