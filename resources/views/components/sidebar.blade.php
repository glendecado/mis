...
<div x-data="{ 
    ...
    x-cloak
    @click.outside="closeSidebarOnOutsideClick()"
    :class="sidebar ? 'w-52 absolute md:relative px-4' : 'w-14 relative px-2'"
    ...
    <nav class="flex flex-col gap-3">
        ...
        <a wire:navigate.hover href="/request?status={{ Cache::get('status_'.session('user')['id']) ?? 'all' }}">
            <div :class="sidebar ? 'justify-start' : 'justify-center'"
                ...
                <span x-show="sidebar" x-cloak class="whitespace-nowrap">REQUEST</span>
            </div>
        </a>
        ...
        <a wire:navigate.hover href="/category">
            <div :class="sidebar ? 'justify-start' : 'justify-center'"
                ...
                <span x-show="sidebar" x-cloak class="whitespace-nowrap">CATEGORY</span>
            </div>
        </a>
        ...
        <a wire:navigate.hover href="/user?roles=all">
            <div :class="sidebar ? 'justify-start' : 'justify-center'"
                ...
                <span x-show="sidebar" x-cloak class="whitespace-nowrap">USERS</span>
            </div>
        </a>
        ...
        <a wire:navigate.hover href="/reports">
            <div :class="sidebar ? 'justify-start' : 'justify-center'"
                ...
                <span x-show="sidebar" x-cloak class="whitespace-nowrap">REPORTS</span>
            </div>
        </a>
    </nav>
</div>
