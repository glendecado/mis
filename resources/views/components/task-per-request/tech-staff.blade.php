...
<div class="flex flex-col">
    <div class="flex items-center justify-between">
        ...
        <span class="text-blue text-[16px] font-semibold mb-2">Completed Tasks: {{ $checked }} / {{$taskPerReq->count()}}</span>
    </div>
    ...
    @foreach ($taskPerReq as $list)
        <div class="flex items-center mb-2 w-full">
            ...
            <button type="button"
                ...
                <div class="w-5 h-5 flex items-center justify-center border rounded-full transition-all 
