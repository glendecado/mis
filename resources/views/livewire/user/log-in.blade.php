            ...
            <div class="my-[50px]">
                <form wire:submit.prevent="login" method="post">
                    <div class="relative mt-6">
                        <input type="email" name="email" id="email" placeholder="Email Address" class="peer mt-1 w-full border-b-2 border-gray-300 px-0 py-1 placeholder:text-transparent focus:border-gray-500 focus:outline-none" autocomplete="NA" wire:model="email" />
                        ...
                        @if ($emailError)
                        <div class="mt-1 text-sm text-red-600 absolute">❌ {{ $emailError }}</div>
                        @endif
                    </div>
                    <div class="relative mt-9">
                        <input type="password" name="password" id="password" placeholder="Password" class="peer mt-1 w-full border-b-2 border-gray-300 px-0 py-1 placeholder:text-transparent focus:border-gray-500 focus:outline-none" wire:model="password" />
                        ...
                        @if ($passwordError)
                        <div class="mt-1 text-sm text-red-600 absolute">❌ {{ $passwordError }}</div>
                        @endif
                    </div>
