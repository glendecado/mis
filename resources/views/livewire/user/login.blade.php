                ...
                <form wire:submit.prevent="login" method="post">
                    ...
                    <div class="relative z-0">
                        ...
                        <label for="floating_standard"
                            class="absolute top-3 z-10 origin-[0] -translate-y-[35px] scale-75 transform  duration-300 peer-placeholder-shown:translate-y-0 text-lg peer-focus:start-0 peer-focus:-translate-y-[35px] peer-focus:scale-75 peer-focus:text-yellow rtl:peer-focus:left-auto rtl:peer-focus:translate-x-1/4 ml-2 text-gray-500">Email
                            Address</label>
                    ...
                    <div class="relative mt-9" x-data="{ password: true }">
                        <input :type="password ? 'password' : 'text'" wire:model.lazy="password" autocomplete="off"
                            ...
                            placeholder=" " />
                        <label for="floating_standard"
                            class="absolute top-3 z-10 origin-[0] -translate-y-[35px] scale-75 transform  duration-300 peer-placeholder-shown:translate-y-0 text-lg peer-focus:start-0 peer-focus:-translate-y-[35px] peer-focus:scale-75 peer-focus:text-yellow rtl:peer-focus:left-auto rtl:peer-focus:translate-x-1/4 ml-2 text-gray-500">password</label>
