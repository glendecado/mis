        ...
        <table class="min-w-full bg-white border border-gray-300">
                ...
                <tr class="border-b border-gray-300 hover:bg-gray-100">
                    ...
                    <td class="py-3 px-6">
                        ...
                        <button
                            ...
                            class="bg-blue-900 text-white py-2 px-4 rounded shadow-md hover:bg-yellow hover:text-blue-900 relative h-10 w-32"
            ...
            $dispatch('view-request')">
                        ...
                        <button
                            wire:loading.attr="disabled"
                            wire:loading.class="bg-transparent border-none shadow-none hover:bg-transparent"
                            class="bg-gray-200 text-gray-800 py-2 px-4 rounded shadow-md hover:bg-blue-900 hover:text-white relative h-10 w-32 "
                            @click="$dispatch('add-task', {request_id: '{{ $id ?? '' }}', tech_id: '{{ $tech->user->id }}' }); 
            $dispatch('view-task'); 
            $dispatch('view-request')">
                            <span wire:loading.remove>Add</span>
