<div>
    ...
    <div class="overflow-hidden flex justify-center mt-2 flex-col items-center gap-2 ">
        ...
        <div class="flex flex-col md:flex-row gap-x-4 justify-center items-center overflow-auto text-pretty bg-blue-950 text-white w-[1000px] p-2 rounded-lg mx-2 md:mx-0 shadow-md" wire:loading.remove>
            <div>
